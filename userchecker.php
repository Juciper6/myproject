        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'userchecker.php?del=' + id;
                }
            })
        }
    </script>
...
<body>
    <div class="container mx-auto p-4">
        <h1 class="text-center text-3xl font-bold text-gray-800">NOTEPAD USERS</h1>
                ...
                <tbody>
                    ...
                    ?>
                            <tr class="bg-white border-b hover:bg-gray-100">
                                ...
                                <td class="border px-4 py-2"><?php echo htmlentities($result['users']); ?></td>
                                <td class="border px-4 py-2"><?php echo htmlentities($result['title']); ?></td>
                                <td class="border px-4 py-2"><?php echo htmlentities($result['messages']); ?></td>
